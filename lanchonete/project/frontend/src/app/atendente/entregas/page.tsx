      ...
      {isLoading ? (
        ...
        <div className="grid gap-4">
          {deliveries.map((delivery) => {
            const displayStatus = delivery.order?.status === "cancelado" ? "cancelado" : delivery.status;
            ...
            return (
              <div key={delivery.id} className="bg-white rounded-2xl border border-surface-100 p-5 animate-fade-up">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold font-body ${STATUS_COLOR[displayStatus]}`}>
